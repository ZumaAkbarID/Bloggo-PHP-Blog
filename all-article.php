      ...
      <div class="col-lg-8 col-md-10 mx-auto">
        <table class="table table-lg table-bordered table-hover table-striped">
            ...
            <tbody>
                    ...
                    <?php
                        $DataOnePage = 5;
                        $check3 = $check = mysqli_query($connect, "SELECT * FROM article");
                        ...
                        $i = 1;
                        $check = mysqli_query($connect, "SELECT * FROM article ORDER BY article_id ASC LIMIT $FirstData, $DataOnePage");
